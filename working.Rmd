...
First I will talk about the LinUCB algorithm with linear disjoint models, following @li2010contextual. I'm starting with this paper is because it is the most cited paper on contextual bandits and I found it (sort of) easy to understand.
